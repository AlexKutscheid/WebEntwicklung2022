...
class ModelException extends FrameworkException
{
    ...
    {
        return new static(lang('DatabaseController.noPrimaryKey', [$modelName]));
    }

    public static function forNoDateFormat(string $modelName)
    {
        return new static(lang('DatabaseController.noDateFormat', [$modelName]));
    }

    public static function forMethodNotAvailable(string $modelName, string $methodName)
    {
        return new static(lang('DatabaseController.methodNotAvailable', [$modelName, $methodName]));
    }
}
